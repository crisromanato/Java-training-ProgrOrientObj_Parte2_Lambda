package ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap18_Interfaces.ModeloComInterface.application;

import ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap18_Interfaces.ModeloComInterface.model.entities.CarRental1;
import ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap18_Interfaces.ModeloComInterface.model.entities.Vehicle;
import ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap18_Interfaces.ModeloComInterface.model.services.BrazilTaxService1;
import ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap18_Interfaces.ModeloComInterface.model.services.RentalService1;
...
public class ProgramCap18_comInterface {
    /*
 ...
 */
        CarRental1 cr = new CarRental1(start, finish, new Vehicle(carModel));
/*
...
/*
instanciar o RentalService e o tax service (primeiro momento)
No segundo momento para usarmos o processo via interface mudando de tax
service para brazil tax service.
aqui temos um up casting a classe onde a classe Brazil é um subtipo de
taxservice.
 ...
 */
        RentalService1 rentalService = new RentalService1(pricePerDay, pricePerHour, new BrazilTaxService1());
/*
