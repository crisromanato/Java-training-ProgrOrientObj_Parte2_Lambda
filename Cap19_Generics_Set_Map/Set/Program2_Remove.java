 ...
 */
            ...
            System.out.println ("Impressao via Hashset - sem ordem definida e " +
                                "removido 'Tablet' ");
 ...
 */
            ...
            /*
            (predicado)
            remova x tal que o comprimento seja > ou igual a 3
             */
            ...
            System.out.println ("Impressao via Treeset - ordem definida e " +
                                "removido itens com comprimento maior ou igual" +
                                "a 3 ");
            System.out.println(set.contains("Notebook"));
  /*
            impressao
 ...
 */
            ...
            System.out.println ("Impressao via LinkedHashSet - na ordem que foram " +
                                "adicionados e removido itens iniciados com 'T' ");
            System.out.println(set.contains("Notebook"));
  /*
            impressao
             */
