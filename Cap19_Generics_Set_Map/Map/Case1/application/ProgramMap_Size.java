...
/*
imprime verdadeiro ou faso para a chave q definimos
 */
        System.out.println ("Contains 'phone' key: " + cookies.containsKey ("phone"));

        /*
imprime o valor da chave q definimos
 */
        System.out.println ("Valor do Phone number: " + cookies.get ("phone"));
    /*
Get o valor da chave q definimos
veja que deu nulo porque colocamos um remove acima.
 */
        System.out.println ("Valor do Email(get): " + cookies.get ("email"));

         /*
imprime o tamanho do Map q definimos
 */
