package ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Funcoes.Case1_Impl_Interface.application;
...
import ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Funcoes.Case1_Impl_Interface.util.UpperCaseName1;
 ...
 */
public class ProgrFunction1 {
    public static void main (String[] args) {

        Locale.setDefault (Locale.US);
       List<ProductFunction1> list = new ArrayList<> ();

        System.out.println ("Consumer usando funcao via interface classe ");
        
    list.add (new ProductFunction1 ("Tv", 900.00));
    list.add (new ProductFunction1 ("Mouse", 50.00));
    list.add (new ProductFunction1 ("Tablet", 350.50));
    list.add (new ProductFunction1 ("HD Case", 80.90));
...
List<String> names = list.stream().map(new UpperCaseName1 ()).collect(
                Collectors.toList ());
