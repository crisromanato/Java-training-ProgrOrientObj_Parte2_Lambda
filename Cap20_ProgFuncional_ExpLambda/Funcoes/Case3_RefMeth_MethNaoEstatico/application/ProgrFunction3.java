package ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Funcoes.Case3_RefMeth_MethNaoEstatico.application;

import ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Funcoes.Case3_RefMeth_MethNaoEstatico.entities.ProductFunction3;
 ...
 */
public class ProgrFunction3 {
    public static void main (String[] args) {

        Locale.setDefault (Locale.US);
       List<ProductFunction3> list = new ArrayList<> ();

        System.out.println ("Consumer usando non static method ");
        
    list.add (new ProductFunction3 ("Tv", 900.00));
    list.add (new ProductFunction3 ("Mouse", 50.00));
    list.add (new ProductFunction3 ("Tablet", 350.50));
    list.add (new ProductFunction3 ("HD Case", 80.90));
...
List<String> names = list.stream().map
        (ProductFunction3 :: nonStaticUpperCaseName).collect (
                Collectors.toList ());
