package ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Predicate.Case4_RefMeth_MethNaoEstatico.application;
 ...
 */
public class ProgrPredicate4 {
    public static void main (String[] args) {

        System.out.println ("Predicate com Implementacao methd reference - nao estatico");
        Locale.setDefault (Locale.US);
       List<ProductPred4> list = new ArrayList<> ();

    list.add (new ProductPred4 ("Tv", 900.00));
    list.add (new ProductPred4 ("Mouse", 50.00));
    list.add (new ProductPred4 ("Tablet", 350.50));
    list.add (new ProductPred4 ("HD Case", 80.90));
...
esta :: e o nome do metodo nao estatico de dentro da classe.
TAmbém é aceito no sistema lambido do java.

 */
		list.removeIf (ProductPred4 :: nonStaticProductPredicate4);
/*
