package ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Consumer.Case3_RefMeth_MethNaoEstatico.application;
 ...
 */
public class ProgrConsumer3 {
    public static void main (String[] args) {

        Locale.setDefault (Locale.US);
       List<ProductConsumer3> list = new ArrayList<> ();

        System.out.println ("Consumer usando Method nonStatic da classe produto ");
        
    list.add (new ProductConsumer3 ("Tv", 900.00));
    list.add (new ProductConsumer3 ("Mouse", 50.00));
    list.add (new ProductConsumer3 ("Tablet", 350.50));
    list.add (new ProductConsumer3 ("HD Case", 80.90));
...
list.forEach (ProductConsumer3 :: nonStaticPriceUpdate);
