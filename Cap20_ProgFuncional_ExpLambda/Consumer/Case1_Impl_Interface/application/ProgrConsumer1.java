package ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Consumer.Case1_Impl_Interface.application;
...
import ProgramacaoOrientadaObjetos_Parte2_Lambda.Cap20_ProgFuncional_ExpLambda.Consumer.Case1_Impl_Interface.util.PriceUpdateConsumer1;
 ...
 */
public class ProgrConsumer1 {
    public static void main (String[] args) {

        Locale.setDefault (Locale.US);
       List<ProductConsumer1> list = new ArrayList<> ();

        System.out.println ("Consumer usando interface classe ");
        
    list.add (new ProductConsumer1 ("Tv", 900.00));
    list.add (new ProductConsumer1 ("Mouse", 50.00));
    list.add (new ProductConsumer1 ("Tablet", 350.50));
    list.add (new ProductConsumer1 ("HD Case", 80.90));
...
list.forEach (new PriceUpdateConsumer1 ());
